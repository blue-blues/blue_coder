...
import type { BluesAICoderMessage } from "@shared/ExtensionMessage"
...
export class FileContextTracker {
	 ...
	 */
	async detectFilesEditedAfterMessage(messageTs: number, deletedMessages: BluesAICoderMessage[]): Promise<string[]> {
