...
export async function refreshExternalRulesToggles(
	...
	windsurfLocalToggles: BluesAICoderRulesToggles
	cursorLocalToggles: BluesAICoderRulesToggles
}> {
	// local windsurf toggles
	const localWindsurfRulesToggles = ((await getWorkspaceState(context, "localWindsurfRulesToggles")) as BluesAICoderRulesToggles) || {}
	...
	const localCursorRulesToggles = ((await getWorkspaceState(context, "localCursorRulesToggles")) as BluesAICoderRulesToggles) || {}
 ...
 */
export const getLocalWindsurfRules = async (cwd: string, toggles: BluesAICoderRulesToggles) => {
 ...
 */
export const getLocalCursorRules = async (cwd: string, toggles: BluesAICoderRulesToggles) => {
