...
export async function updateDefaultTerminalProfile(
	...
	request: proto.bluesaicoder.StringRequest,
): Promise<proto.bluesaicoder.TerminalProfileUpdateResponse> {
	...
	return proto.bluesaicoder.TerminalProfileUpdateResponse.create({
		closedCount,
