...
import { BluesAiCoderMessage as ProtoBluesAiCoderMessage } from "@shared/proto/ui"
import { StreamingResponseHandler, getRequestRegistry } from "../grpc-handler"

// Keep track of active partial message subscriptions
const activePartialMessageSubscriptions = new Set<StreamingResponseHandler<ProtoBluesAiCoderMessage>>()
...
export async function subscribeToPartialMessage(
	...
	responseStream: StreamingResponseHandler<ProtoBluesAiCoderMessage>,
	requestId?: string,
): Promise<void> {
 ...
 * @param partialMessage The ProtoBluesAiCoderMessage to send
 */
export async function sendPartialMessageEvent(partialMessage: ProtoBluesAiCoderMessage): Promise<void> {
