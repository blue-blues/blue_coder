	...
	inputSchema: {
		...
		properties: {
			...
			requires_approval: {
				type: "boolean",
				description:
					"If true, this command requires user approval before execution. Set to true for any command that modifies the system, such as installing packages, deleting files, or changing configurations.",
			},
			reason: {
				type: "string",
