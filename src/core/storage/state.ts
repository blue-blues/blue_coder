...
export async function getAllExtensionState(context: vscode.ExtensionContext) {
	...
	const [
		...
		getSecret(context, "bluesAiCoderAccountId") as Promise<string | undefined>,
		...
		getGlobalState(context, "globalBluesAICoderRulesToggles") as Promise<BluesAICoderRulesToggles | undefined>,
		...
		getGlobalState(context, "globalWorkflowToggles") as Promise<BluesAICoderRulesToggles | undefined>,
	...
	const localBluesAICoderRulesToggles = (await getWorkspaceState(context, "localBluesAICoderRulesToggles")) as BluesAICoderRulesToggles
