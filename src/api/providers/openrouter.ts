		...
		if (!this.client) {
			...
			try {
				this.client = new OpenAI({
					...
					defaultHeaders: {
						"HTTP-Referer": "https://bluesaicoder.bot", // Optional, for including your app on openrouter.ai rankings.
						"X-Title": "BluesAICoder", // Optional. Shows in rankings on openrouter.ai.
					},
				})
			} catch (error: any) {
