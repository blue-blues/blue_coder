...
import { BluesAICoderError } from "./BluesAICoderError"
...
export class ErrorService {
	...
	static initialize() {
		...
		Sentry.init({
			...
			release: `bluesaicoder@${pkg.version}`,
	...
	static logException(error: Error | BluesAICoderError): void {
	...
	static toBluesAICoderError(rawError: any, modelId?: string, providerId?: string): BluesAICoderError {
		return BluesAICoderError.transform(rawError, modelId, providerId)
	}
}
