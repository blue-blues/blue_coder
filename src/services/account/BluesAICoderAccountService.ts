...
import type {
	...
	UsageTransaction,
	UserResponse,
} from "@shared/BluesAiCoderAccount"
import { AuthService } from "../auth/AuthService"
import { bluesAICoderEnvConfig } from "@/config"

export class BluesAICoderAccountService {
	private static instance: BluesAICoderAccountService
	...
	/**
	 * Returns the singleton instance of BluesAICoderAccountService
	 * @returns Singleton instance of BluesAICoderAccountService
	 */
	public static getInstance(): BluesAICoderAccountService {
		if (!BluesAICoderAccountService.instance) {
			BluesAICoderAccountService.instance = new BluesAICoderAccountService()
		}
		return BluesAICoderAccountService.instance
	}

	/**
	 * Returns the base URL for the Blues-AI Coder API
	...
	/**
	 * Helper function to make authenticated requests to the Blues-AI Coder API
	...
	private async authenticatedRequest<T>(endpoint: string, config: AxiosRequestConfig = {}): Promise<T> {
		...
		const requestConfig: AxiosRequestConfig = {
			...config,
			headers: {
				Authorization: `Bearer ${bluesAiCoderAccountAuthToken}`,
