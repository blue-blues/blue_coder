...
import { BluesAICoderAsk, ExtensionMessage } from "@shared/ExtensionMessage"
			...
			try {
				...
				try {
					...
					if (apiKey) {
						...
						await storeSecret(visibleWebview.controller.context, "bluesAiCoderAccountId", apiKey)
 ...
 */
async function autoRespondToAsk(webviewProvider: WebviewProvider, askType: BluesAICoderAsk, askText?: string): Promise<void> {
