 ...
 * GitOperations Class
 *
 * Handles git-specific operations for BluesAICoder's Checkpoints system.
 *
...
export class GitOperations {
	...
	public async initShadowGit(gitPath: string, cwd: string, taskId: string): Promise<string> {
		...
		await git.addConfig("user.name", "BluesAICoder Checkpoint")
		await git.addConfig("user.email", "checkpoint@bluesaicoder.bot")
