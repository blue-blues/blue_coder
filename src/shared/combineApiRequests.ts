...
/**
 * Combines API request start and finish messages in an array of BluesAICoderMessages.
 *
 ...
 * @returns A new array of BluesAICoderMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: BluesAICoderMessage[]): BluesAICoderMessage[] {
	const combinedApiRequests: BluesAICoderMessage[] = []
