import { BluesAICoderMessage } from "./ExtensionMessage"

/**
 * Combines sequences of command and command_output messages in an array of BluesAICoderMessages.
 *
 * This function processes an array of BluesAICoderMessage objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of BluesAICoderMessage objects to process.
 * @returns A new array of BluesAICoderMessage objects with command sequences combined.
 *
 * @example
 * const messages: BluesAICoderMessage[] = [
 ...
 */
export function combineCommandSequences(messages: BluesAICoderMessage[]): BluesAICoderMessage[] {
	const combinedCommands: BluesAICoderMessage[] = []
