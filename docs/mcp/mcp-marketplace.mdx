...
-   This file is located at: `/Users/<username>/Library/Application Support/Code/User/globalStorage/saoudrizwan.claude-dev/settings/bluesaicoder_mcp_settings.json`
...
1. Open the MCP settings file: `/Users/<username>/Library/Application Support/Code/User/globalStorage/saoudrizwan.claude-dev/settings/bluesaicoder_mcp_settings.json`
...
-   Try removing and reinstalling the server (remove from both the `bluesaicoder_mcp_settings.json` file and the `/Users/<username>/Documents/Cline/MCP/` directory)
...
Utilize a `.bluesaicoderrules` file or custom instructions to support intelligent MCP server activation through keyword-based triggers, making Cline's tool selection more intuitive and context-aware.
...
Add this to your `.bluesaicoderrules` file or to your custom instructions to make Cline's MCP server selection more intuitive and context-aware.
