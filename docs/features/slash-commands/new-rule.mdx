...
`/newrule` is a slash command that lets you teach Cline your preferred way of working. It creates a markdown file in your `.bluesaicoderrules` directory that acts like persistent instructions for how Cline should behave when helping with your projects.
...
-   Once approved, Cline creates a markdown file in your `.bluesaicoderrules` directory that will automatically be loaded for future conversations
