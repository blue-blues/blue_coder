...
Workflows live alongside [Cline Rules](/features/bluesaicoder-rules). Creating one is straightforward:

<Frame>
	<img src="https://storage.googleapis.com/bluesaicoder_public_images/docs/assets/workflows.png" alt="Workflows tab in Cline" />
</Frame>
...
-   Leverage Cline's [built-in tools](/exploring-bluesaicoders-tools/bluesaicoder-tools-guide) like `ask_followup_question`, `read_file`, `search_files`, and `new_task`
...
> This is just one example of a workflow file. You can find more in our [prompts repository](https://github.com/bluesaicoder/prompts) for inspiration.
