...
| ---------------------------------------------------------------------------------------- | --------------------------------------------- |
| [`bluesaicoder.openInNewTab`](/features/commands-and-shortcuts/overview)                        | Opens Cline in a new editor tab               |
| [`bluesaicoder.addToChat`](/features/commands-and-shortcuts/code-commands)                      | Adds selected code to Cline chat              |
| [`bluesaicoder.addTerminalOutputToChat`](/features/commands-and-shortcuts/terminal-integration) | Adds terminal output to Cline                 |
| `bluesaicoder.focusChatInput`                                                                   | Focuses the Cline chat input field            |
| [`bluesaicoder.generateGitCommitMessage`](/features/commands-and-shortcuts/git-integration)     | Generates a commit message for staged changes |
| [`bluesaicoder.explainCode`](/features/commands-and-shortcuts/code-commands)                    | Explains selected code                        |
| [`bluesaicoder.improveCode`](/features/commands-and-shortcuts/code-commands)                    | Suggests improvements for selected code       |
| [`bluesaicoder.fixWithCline`](/features/commands-and-shortcuts/code-commands)                   | Fixes code with errors                        |
...
| New Task              | `Alt+N`                        | `bluesaicoder.plusButtonClicked`                 | Starts a new Cline task       |
| Add Terminal to Cline | `Alt+T`                        | `bluesaicoder.addTerminalOutputToChat`           | Adds terminal output to Cline |
...
<Frame>
	<img
		src="https://storage.googleapis.com/bluesaicoder_public_images/docs/assets/editor-integration.png"
