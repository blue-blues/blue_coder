...
<Frame>
	<img
		src="https://storage.googleapis.com/bluesaicoder_public_images/docs/assets/image%20(13).png"
...
<Frame caption="Reverting both codebase and task to before any changes were made to start fresh">
	<img src="https://storage.googleapis.com/bluesaicoder_public_images/docs/assets/checkpointsDemo.gif" alt="Checkpoint restore demo" />
</Frame>
