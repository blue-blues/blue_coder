...
3. **Paste into Cline** - Add as custom instructions or in a .bluesaicoderrules file
...
<Frame>
	<img src="https://storage.googleapis.com/bluesaicoder_public_images/docs/assets/image%20(15).png" alt="Memory Bank Workflow" />
</Frame>
...
<Frame>
	<img src="https://storage.googleapis.com/bluesaicoder_public_images/docs/assets/image%20(16).png" alt="Memory Bank File Structure" />
</Frame>
...
<Frame>
	<img src="https://storage.googleapis.com/bluesaicoder_public_images/docs/assets/image%20(17).png" alt="Memory Bank Setup" />
</Frame>
...
#### Should I use custom instructions or .bluesaicoderrules?
...
-   **.bluesaicoderrules file**: Project-specific and stored in your repository. Good for per-project customization.
...
<Frame>
	<img src="https://storage.googleapis.com/bluesaicoder_public_images/docs/assets/image%20(18).png" alt="Memory Bank Context Window" />
</Frame>
...
#### For .bluesaicoderrules (Project-Specific)

1. Create a `.bluesaicoderrules` file in your project root
...
_For more information, reference our_ [_blog_](https://bluesaicoder.bot/blog/memory-bank-how-to-make-bluesaicoder-an-ai-agent-that-never-forgets) _on Cline Memory Bank_
