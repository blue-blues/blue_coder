...
We use PostHog, an open-source analytics platform, for data collection and analysis. Our telemetry implementation is fully transparent - you can review the [source code](https://github.com/bluesaicoder/bluesaicoder/blob/main/src/services/posthog/telemetry/TelemetryService.ts) to see exactly what we track.
...
For complete transparency, you can inspect our [telemetry implementation](https://github.com/bluesaicoder/bluesaicoder/blob/main/src/services/posthog/telemetry/TelemetryService.ts) to see the exact events we track.
