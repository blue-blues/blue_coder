...
<Frame caption="VS Code marketplace with Cline extension ready to install">
	<img
		src="https://storage.googleapis.com/bluesaicoder_public_images/docs/assets/image%20(20).png"
...
1. **Sign In to Cline:**
    ...
    - You'll be taken to [app.bluesaicoder.bot](https://app.bluesaicoder.bot) to create your account.
