		...
		<div ref={modalRef}>
			<div
				...
				<div className="flex justify-between items-center mb-3">
					<HeroTooltip
						content="Auto-approve allows BluesAICoder to perform the following actions without asking for permission. Please use with caution and only enable if you understand the risks."
						placement="top">
				...
				<HeroTooltip
					content="BluesAICoder will automatically make this many API requests before asking for approval to proceed with the task."
					placement="top">
