		...
		<div style={containerStyle}>
			...
			<Accordion isCompact className="pl-0">
				<AccordionItem
					...
					<ul style={ulStyle}>
						<li>
							<b>Optimized for Claude 4:</b> Blues-AI Coder is now optimized to work with the Claude 4 family of models,
						...
						<li>
							<b>WebFetch Tool:</b> Gemini 2.5 Pro and Claude 4 models now support the WebFetch tool, allowing Blues-AI Coder
							to retrieve and summarize web content directly in conversations.
						</li>
						<li>
							<b>Self Knowledge:</b> When using frontier models, Blues-AI Coder is self-aware about his capabilities and
							featureset.
						</li>
						<li>
			...
			<p style={linkContainerStyle}>
				Join us on{" "}
				<VSCodeLink style={linkStyle} href="https://x.com/Blues-AI_Coder">
					X,
				</VSCodeLink>{" "}
				<VSCodeLink style={linkStyle} href="https://discord.gg/blues-ai-coder">
					discord,
				</VSCodeLink>{" "}
				or{" "}
				<VSCodeLink style={linkStyle} href="https://www.reddit.com/r/blues-ai-coder/">
					r/blues-ai-coder
				</VSCodeLink>
				for more updates!
			</p>
