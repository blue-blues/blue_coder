...
const TaskTimelineTooltip = ({ message, children }: TaskTimelineTooltipProps) => {
	const getMessageDescription = (message: BluesAICoderMessage): string => {
		if (message.type === "say") {
			switch (message.say) {
	...
	const getMessageContent = (message: BluesAICoderMessage): string => {
		if (message.text) {
	...
	const getTimestamp = (message: BluesAICoderMessage): string => {
		if (message.ts) {
