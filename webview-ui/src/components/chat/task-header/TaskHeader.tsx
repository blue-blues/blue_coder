...
const TaskHeader: React.FC<TaskHeaderProps> = ({
	...
	const { apiConfiguration, currentTaskItem, checkpointTrackerErrorMessage, bluesAiCoderMessages, navigateToSettings, chatSettings } =
		useExtensionState()
					...
					<>
						...
						<div
							...
							<div className="flex flex-col">
								<TaskTimeline messages={bluesAiCoderMessages} onBlockClick={onScrollToMessage} />
									...
									<span>
										...
										{checkpointTrackerErrorMessage.includes("Git must be installed to use checkpoints.") && (
											<>
												{" "}
												<a
													href="https://github.com/Blues-AI/blues-ai-coder/wiki/Installing-Git-for-Checkpoints"
													style={{
														color: "inherit",
