...
import BluesAiCoderRulesToggleModal from "../blues-ai-coder-rules/BluesAiCoderRulesToggleModal"
			...
			<div>
				...
				<ControlsContainer>
					...
					<Tooltip
						...
						tipText={`In ${shownTooltipMode === "act" ? "Act" : "Plan"}  mode, Blues-AI Coder will ${shownTooltipMode === "act" ? "complete the task immediately" : "gather information to architect a plan"}`}
