...
import { BluesAICoderMessage, BluesAICoderSayTool } from "@shared/ExtensionMessage"
 ...
 */
export function useButtonState(messages: BluesAICoderMessage[], chatState: ChatState) {
	const {
		setSendingDisabled,
		setEnableButtons,
				...
				case "ask":
					...
					switch (lastMessage.ask) {
						...
						case "tool":
							...
							const tool = JSON.parse(lastMessage.text || "{}") as BluesAICoderSayTool
							switch (tool.tool) {
