 ...
 */
export function useMessageHandlers(messages: BluesAICoderMessage[], chatState: ChatState, isStreaming: boolean): MessageHandlers {
	const {
		inputValue,
		setInputValue,
		activeQuote,
	...
	const handleSendMessage = useCallback(
		async (text: string, images: string[], files: string[]) => {
			...
			if (hasContent) {
				...
				} else if (bluesAICoderAsk) {
					switch (bluesAICoderAsk) {
						case "followup":
		...
		async (text?: string, images?: string[], files?: string[]) => {
			...
			switch (bluesAICoderAsk) {
				...
				case "resume_completed_task":
					...
					break
				case "new_task":
					console.info("new task button clicked!", { lastMessage, messages, bluesAICoderAsk, text })
