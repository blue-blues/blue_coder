 ...
 */
export function useChatState(messages: BluesAICoderMessage[]): ChatState {
	...
	const bluesAICoderAsk = useMemo(() => (lastMessage?.type === "ask" ? lastMessage.ask : undefined), [lastMessage])
