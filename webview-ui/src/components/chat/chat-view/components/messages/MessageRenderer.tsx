...
interface MessageRendererProps {
	index: number
	messageOrGroup: BluesAICoderMessage | BluesAICoderMessage[]
	groupedMessages: (BluesAICoderMessage | BluesAICoderMessage[])[]
...
export const createMessageRenderer = (
	...
	return (index: number, messageOrGroup: BluesAICoderMessage | BluesAICoderMessage[]) => (
		<MessageRenderer
			index={index}
