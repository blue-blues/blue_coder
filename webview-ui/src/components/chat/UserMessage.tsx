...
const UserMessage: React.FC<UserMessageProps> = ({ text, images, files, messageTs, sendMessageFromChatRow }) => {
	...
	const handleRestoreWorkspace = async (type: BluesAICoderCheckpointRestore) => {
...
interface RestoreButtonProps {
	type: BluesAICoderCheckpointRestore
	label: string
	isPrimary: boolean
	onClick: (type: BluesAICoderCheckpointRestore) => void
	title?: string
}
