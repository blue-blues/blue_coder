...
import { BluesAICoderCheckpointRestore } from "@shared/WebviewMessage"
...
export const CheckmarkControl = ({ messageTs, isCheckpointCheckedOut }: CheckmarkControlProps) => {
	...
	const handleRestoreTask = async () => {
		...
		try {
			const restoreType: BluesAICoderCheckpointRestore = "task"
	...
	const handleRestoreWorkspace = async () => {
		...
		try {
			const restoreType: BluesAICoderCheckpointRestore = "workspace"
			await CheckpointsServiceClient.checkpointRestore(
				CheckpointRestoreRequest.create({
					number: messageTs,
					restoreType,
	...
	const handleRestoreBoth = async () => {
		...
		try {
			const restoreType: BluesAICoderCheckpointRestore = "taskAndWorkspace"
			await CheckpointsServiceClient.checkpointRestore(
				CheckpointRestoreRequest.create({
					number: messageTs,
					restoreType,
