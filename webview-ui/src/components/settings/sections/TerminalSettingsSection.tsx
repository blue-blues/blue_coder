				...
				<div id="terminal-settings-section" className="mb-5">
					<div className="mb-4">
						...
						<p className="text-xs text-[var(--vscode-descriptionForeground)] mt-1">
							Select the default terminal Blues-AI Coder will use. 'Default' uses your VSCode global setting.
						</p>
					</div>
					...
					<div className="mb-4">
						...
						<p className="text-xs text-[var(--vscode-descriptionForeground)]">
							Set how long Blues-AI Coder waits for shell integration to activate before executing commands. Increase this
					...
					<div className="mb-4">
						...
						<p className="text-xs text-[var(--vscode-descriptionForeground)]">
							When enabled, Blues-AI Coder will reuse existing terminal windows that aren't in the current working directory.
					...
					<div className="mt-5 p-3 bg-[var(--vscode-textBlockQuote-background)] rounded border border-[var(--vscode-textBlockQuote-border)]">
						<p className="text-[13px] m-0">
							...
							<a
								href="https://docs.blues-ai-coder.com/troubleshooting/terminal-quick-fixes"
							...
							or the{" "}
							<a
								href="https://docs.blues-ai-coder.com/troubleshooting/terminal-integration-guide"
								className="text-[var(--vscode-textLink-foreground)] underline hover:no-underline"
								target="_blank"
								rel="noopener noreferrer">
