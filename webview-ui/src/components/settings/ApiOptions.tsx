...
import { BluesAiCoderProvider } from "./providers/BluesAiCoderProvider"
		...
		<div style={{ display: "flex", flexDirection: "column", gap: 5, marginBottom: isPopup ? -10 : 0 }}>
			<DropdownContainer className="dropdown-container">
				...
				<VSCodeDropdown
					...
					<VSCodeOption value="blues-ai-coder">Blues-AI Coder</VSCodeOption>
			...
			{apiConfiguration && selectedProvider === "blues-ai-coder" && (
				<BluesAiCoderProvider showModelOptions={showModelOptions} isPopup={isPopup} currentMode={currentMode} />
			)}
