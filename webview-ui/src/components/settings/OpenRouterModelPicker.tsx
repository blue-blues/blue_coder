...
// Featured models for Blues-AI Coder provider
const featuredModels = [
	{
		id: "anthropic/claude-sonnet-4",
		description: "Recommended for agentic coding in Blues-AI Coder",
		label: "Best",
	},
	{
...
const OpenRouterModelPicker: React.FC<OpenRouterModelPickerProps> = ({ isPopup, currentMode }) => {
	...
	const modelIds = useMemo(() => {
		...
		return modeFields.apiProvider === "blues-ai-coder" ? unfilteredModelIds.filter((id) => !id.includes(":free")) : unfilteredModelIds
	...
	return (
		<div style={{ width: "100%" }}>
			...
			<div style={{ display: "flex", flexDirection: "column" }}>
				...
				{modeFields.apiProvider === "blues-ai-coder" && (
			...
			{hasInfo ? (
				...
				<p
					...
					<>
						...
						If you're unsure which model to choose, Blues-AI Coder works best with{" "}
						<VSCodeLink
