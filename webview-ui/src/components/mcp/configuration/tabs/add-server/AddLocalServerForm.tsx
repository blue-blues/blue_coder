	...
	return (
		<FormContainer>
			<div className="text-[var(--vscode-foreground)]">
				Add a local MCP server by configuring it in <code>blues-ai-coder_mcp_settings.json</code>. You'll need to specify the
			...
			<VSCodeButton
				...
				Open blues-ai-coder_mcp_settings.json
			</VSCodeButton>
		</FormContainer>
	)
}
