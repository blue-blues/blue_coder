...
// Set up CLI metadata
program.name("bluesaicoder-eval").description("CLI tool for orchestrating BluesAICoder evaluations across multiple benchmarks").version("0.1.0")
...
program
	...
	.option("-k, --api-key <apiKey>", "BluesAICoder API key to use for evaluations")
	.action(async (options) => {
		try {
